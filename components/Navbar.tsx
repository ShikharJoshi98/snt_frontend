...
import { FaAngleDoubleRight, FaFacebook, FaPhoneAlt } from "react-icons/fa";
        ...
        <>
                ...
                <ul className="list-none py-2 px-5 max-w-6xl mx-auto hidden md:flex items-center justify-between">
                    <li className="flex text-white/70 items-center gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            <p className="cursor-pointer">info@snteducation.com </p>
                        </div>
                        <div className="flex items-center gap-2">
                            <span className="p-1.5 rounded-full bg-[#525fe1]/30"><FaPhoneAlt className="w-3 h-3 text-white" /></span>
                            <p className="cursor-pointer">+91-8261976429</p>
                        </div>
                    </li>
                    <li className="flex text-white items-center gap-4">
                        Follow Us:
                        <span className="flex items-center gap-3 text-white/70">
                            <Link href="https://www.facebook.com/SNTEducation20" target="_blank" ><FaFacebook className="cursor-pointer hover:text-white duration-300" /></Link>
                            <Link href="https://x.com/snteducation" target="_blank" ><FaXTwitter className="cursor-pointer hover:text-white duration-300" /></Link>
                        </span>
                    </li>
                </ul>
            </div>
            <div className="bg-white shadow-md shadow-gray-100">
                <div className="p-3 sm:py-2 sm:px-5 max-w-6xl mx-auto flex items-center justify-between">
                    <Link href="/" >
                        <div className="flex items-center gap-2">
                            <Image src="/sntlogo.jpg" alt="Company Logo" height={60} width={64} className="w-10 h-14 object-cover sm:w-16 rounded-md cursor-pointer" />
                            <h1 className="text-[34px] text-[#0c3b86] urbanist_bold cursor-pointer">SNT</h1>
                        </div>
                    </Link>
