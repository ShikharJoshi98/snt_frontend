    ...
    return (
        <section className="pb-16 px-6">
            <div className="max-w-6xl mx-auto relative flex flex-col lg:flex-row rounded-xl overflow-hidden bg-gradient-to-tl from-black via-slate-900 to-gray-800 shadow-lg">
                ...
                <div className='sm:flex absolute hidden bottom-10 right-10 items-center gap-4 mt-6 sm:mt-0 font-semibold'><span className='p-4 rounded-full bg-[#525fe1]/40'><FaPhoneAlt className='text-[#525fe1]' /></span><span className='text-lg text-white hover:text-[#525fe1] duration-200 cursor-pointer'>+91-8261976429</span></div>
            </div>
